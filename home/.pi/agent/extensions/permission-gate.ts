 ...
 * Patterns checked: rm -rf, sudo, chmod/chown 777, pass subcommands, gpg decrypt/export-secret
 */
...
export default function (pi: ExtensionAPI) {
  const dangerousPatterns = [
    ...
    /\bpass\s+(show|insert|generate|edit|rm|mv|cp|git|grep|find|list|init)\b/i, // pass password-store CLI subcommands
