...
claude:
  enabled: true
  name: research/codebase-locator # Claude-specific field
  tools: "Grep, Glob, LS" # Exact Claude format: comma-separated, capitalized
  model: sonnet # Exact Claude format: short alias
